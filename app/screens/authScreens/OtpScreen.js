...
const OtpScreen = ({ route, navigation }) => {
  ...
  return (
    <View style={{ alignItems: "center", justifyContent: "center", flex: 1 }}>
      ...
      <OTPTextView handleTextChange={setOtp} inputCount={6} on ref={(e) => (this.otpInput = e)} />
      ...
      <Button style={{marginTop:20}} status="success" onPress={()=> confirmOtp()} >Confirm OTP</Button>
    </View>
  );
};
